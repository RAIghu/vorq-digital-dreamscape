    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <video
          ...
          poster="https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1920&h=1080&fit=crop"
        >
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center">
        <div className="text-center px-6 max-w-4xl mx-auto">
          <h1 className="font-orbitron font-black text-6xl md:text-8xl lg:text-9xl mb-6 text-white animate-fade-in">
            VORIQ
          </h1>
          ...
          <Link to="/portfolio">
            <Button 
              size="lg" 
              className="bg-primary hover:bg-primary/90 text-black font-semibold px-8 py-4 text-lg animate-glow transition-all duration-300 hover:scale-105"
            >
              View Portfolio
            </Button>
          </Link>
