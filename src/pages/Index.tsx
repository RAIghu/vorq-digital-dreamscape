...
const Index = () => {
  ...
  return <div className="min-h-screen relative overflow-hidden" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center">
        <div className="text-center px-6 max-w-4xl mx-auto">
          ...
          {isMuted && <>
              ...
              <p className="text-lg md:text-xl mb-12 text-gray-300 max-w-2xl mx-auto animate-fade-in">Where artificial intelligence meets cinematic excellence. Creating award-winning content that pushes the boundaries of what's possible.</p>
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                {showControls && <div className="flex gap-2">
                    <Button variant="ghost" size="sm" onClick={toggleMute} className="glass-effect text-foreground hover:text-primary transition-all duration-300 border border-primary/30 hover:border-primary/60 animate-fade-in h-8 w-8 p-0" style={{
                pointerEvents: 'auto'
              }}>
                      <VolumeX size={14} />
                    </Button>
      ...
      {!isMuted && <div className="absolute bottom-40 right-8 z-10 flex flex-col items-end gap-4">
          <Link to="/portfolio">
            <Button size="lg" className="bg-primary hover:bg-primary/90 text-black font-semibold px-8 py-4 text-lg animate-glow transition-all duration-300 hover:scale-105">
              View Portfolio
            </Button>
          ...
          pointerEvents: 'auto'
              ...
              <Button variant="ghost" size="sm" onClick={togglePlayPause} className="glass-effect text-foreground hover:text-primary transition-all duration-300 border border-primary/30 hover:border-primary/60 animate-fade-in h-8 w-8 p-0" style={{
          pointerEvents: 'auto'
        }}>
      ...
      {isMuted && <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10">
